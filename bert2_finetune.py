...
class Config:
    ...
    epochs = 10
    device = "cuda"
    bert_checkpoint = os.path.join("outputs", "bert2-improved-pretrain-lrscheduler", "bert2"
    "-best.pth")  # Pretrained BERT path
    checkpoint_save_path = os.path.join("outputs", "bert2-finetune")  # Checkpoint save path
